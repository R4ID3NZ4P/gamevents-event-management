...
const WhyChooseUs = () => {
    ...
    return (
        <div className="text-center flex flex-col items-center mt-10">
            ...
            <div className="mb-20 w-9/12 lg:w-1/3 rounded-lg bg-slate-900 text-white px-3 py-2 lg:px-10 px-3 py-2 lg:py-4" data-aos="fade-zoom-in">
            ...
            <div className="mb-20 w-9/12 lg:w-1/3 rounded-lg bg-slate-900 text-white px-3 py-2 lg:px-10 px-3 py-2 lg:py-4" data-aos="fade-up">
            ...
            <div className="mb-20 w-9/12 lg:w-1/3 rounded-lg bg-slate-900 text-white px-3 py-2 lg:px-10 px-3 py-2 lg:py-4" data-aos="fade-down">
            ...
            <div className="mb-20 w-9/12 lg:w-1/3 rounded-lg bg-slate-900 text-white px-3 py-2 lg:px-10 px-3 py-2 lg:py-4" data-aos="fade-left">
            ...
            <div className="mb-20 w-9/12 lg:w-1/3 rounded-lg bg-slate-900 text-white px-3 py-2 lg:px-10 px-3 py-2 lg:py-4" data-aos="fade-right">
